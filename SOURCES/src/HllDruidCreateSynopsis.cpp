...
class HllDruidCreateSynopsis : public AggregateFunction
{
public:
...
class HllDruidCreateSynopsisFactory : public AggregateFunctionFactory
{
  ...
  {
    return vt_createFuncObject<HllDruidCreateSynopsis>(srvInterface.allocator);
  }
